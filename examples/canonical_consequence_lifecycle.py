...
# Public distribution mirror — existing published lifecycle example; no new runtime or protocol authority.
# Implementation source: sdk/aigentsy/examples/canonical_consequence_lifecycle.py @ 212490cbcac0c1848cf5cda15e7702ce410a9dbe
# Verified unchanged through runtime commit c05759b5eb34abad82ea530e85fa0a2e56dcd84b
# Requires: aigentsy==1.16.0 and cryptography>=41.0
#   pip install aigentsy==1.16.0 "cryptography>=41.0"
# The content below the provenance block is an exact reviewed distribution copy.
# Behavioral authority remains with the published SDK and implementation tests.
# The enterprise owns the callback, target system, result, credentials, and private signing key;
# AiGentsy records the causal trail without taking custody of those assets.
# Report drift via this repository's issue tracker.
